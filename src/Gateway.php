...
class Gateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\PurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\AuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\CaptureRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\RefundRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\CreateCustomerRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\CreateCardRequest', $parameters);
    }


    /**
     * Create a getCustomer request
     *
     * @param array $parameters
     * @return \Omnipay\Pin\Message\GetCustomerRequest
     */
    public function getCustomer(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\PinExtended\Message\GetCustomerRequest', $parameters);
    }
}
